#!/usr/bin/env python3
"""Draw Seiya's profile graphics from the GitHub GraphQL API.
...
Env:
  ...
  GH_LOGIN      user to summarise (default: seiya20010317)
...
def main():
    ...
    if not token and shutil.which("gh"):
        try:
            ...
            pass
    if not token:
        sys.exit("GITHUB_TOKEN is not set and no authenticated gh CLI was found")
    login = os.environ.get("GH_LOGIN", "seiya20010317")
    ...
    for word in ("about", "stack", "activity", "about this profile"):
