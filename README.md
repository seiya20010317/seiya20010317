...
<img src="./ascii.svg" width="460" alt="Animated ASCII portrait of Seiya Awano"/>
...
The portrait is generated from my photo with<br>
[`scripts/generate_portrait.py`](scripts/generate_portrait.py): background<br>
removal, edge-preserving smoothing, local contrast, a gentle tone curve, then a<br>
13-character ramp. The source photo is not committed. It types itself once with<br>
SMIL inside the SVG; the charts use the same animation system, so there is no<br>
JavaScript and no third-party widget to rate-limit.
